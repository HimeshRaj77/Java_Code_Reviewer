...
import com.reviewer.codereviewer.config.AppConfig;
...
public class AISuggestionService {
    ...
    private static final String SYSTEM_PROMPT = "You are an expert Java code reviewer helping a developer improve their code. " +
            "Focus on code quality, best practices, potential bugs, and performance issues. " +
            "Be concise but thorough. Provide specific suggestions for improvement when applicable.";
